            ...
            <div class="card ">
              <div class="card-header ">
                ...
                while($get_my=mysqli_fetch_assoc($get_my_courses)){
                  ...
                  $get_active_data = mysqli_query($conn,"select * from quiz_name where start_date<='$date'  and (end_date<='$date' and end_time>='$time')   and course_name='$course_id';");
                ...
                $get_active_data = mysqli_query($conn,"select * from quiz_name where (end_date <'$date') or (end_date='$date' and end_time <='$time') and
