<?php
require("../conn.php");
$sesion_key = $_COOKIE["tech_hash_"];
if($sesion_key==''){
  header("Location: ../login");
}else{
  $check_hashkey = mysqli_query($conn,"select * from teacher where hashkey='$sesion_key';");
  if(mysqli_num_rows($check_hashkey)!=1){
    ...
    if(isset($_POST['add_course'])){
        ...
        mysqli_query($conn,"insert into courses (course_code,course_name) values ('$course_code','$course_name')");
        header("Location: ?couadd=1");
    }
    if($_GET['delete_course']!=''){
        $code = $_GET['delete_course'];
      ...
      <div class="row">
          <div class="col-md-12">
            <div class="card card-chart">
              ...
              ?>
              <form action="courses_list.php" enctype="multipart/form-data" method="post">
            ...
            <div class="card card-chart">
              ...
              <table class="table_course_list">
                 ...
                 while($c=mysqli_fetch_assoc($get_courses))
                 {
                     ...
                     echo "<td style='color: #99bbff;'><a href='update_course.php?update_course=".$c['course_code']."'>Edit</a></td>";
                     echo "<td style='color: red;'><a href='?delete_course=".$c['course_code']."'>Delete</a></td>";
                     echo "<tr>";
                 }
                 ?>
